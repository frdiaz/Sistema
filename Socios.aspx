...
<asp:Content ID="Content1" ContentPlaceHolderID="contenido" runat="Server">
    ...
    <h3 style="margin-left: 20px; margin-top: 0px;">Nutrición<small> Socios</small></h3>

    <button type="button" class="btn btn-primary" onclick="nuevoSocio_show();" style="margin-left: 20px;">Nuevo Socio</button>
    <button type="button" class="btn btn-primary" onclick="Socios_show();" style="margin-left: 20px;">Mostrar Socios</button>
